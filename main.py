...
def quick_fine_tune_demo(train_size: int = 200, val_size: int = 50):
    ...
    print(f"job_id = fine_tuner.start_fine_tuning('{train_file}', '{val_file}')") # After your training completes, this ID will be visible in the terminal!    
# print(f"# Wait for job to complete...") # This is commented out because we are not waiting for the job to complete
